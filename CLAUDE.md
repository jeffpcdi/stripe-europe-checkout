...
- A aba Campanhas é um workspace TikTok-first com níveis internos: Visão, Campanhas, Conjuntos, Anúncios, Criativos, Oportunidades, Aprovações e Playbooks.
...
- A Visão operacional prioriza first-party sales/ROAS, gasto, saúde criativa, aprovações e estado da automação.
