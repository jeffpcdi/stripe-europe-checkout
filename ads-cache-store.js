...
async function readTree(accountId, advertiserId, opts = {}) {
  ...
  // 'approved' (Validadas) é uma dimensão de REVISÃO. Os demais filtros usam
  // exclusivamente o status exibido: incluir childStatus fazia uma campanha
  // "Em revisão" aparecer também em "Ativas", duplicando contagens/subtotais.
