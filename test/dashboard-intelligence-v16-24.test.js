...
assert.match(nav, /\/insights\?tab=simulator/)
...
assert.match(view, /type InsightTab = 'performance' \| 'funnel' \| 'sources' \| 'opportunities' \| 'simulator' \| 'anomalies' \| 'quality'/)
...
assert.match(simulator, /Hipóteses/)
assert.match(simulator, /Cenário projetado/)
