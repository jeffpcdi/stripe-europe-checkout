...
function completeSchemas() {
  ...
  const ad = Object.fromEntries([
    'advertiser_id', 'adgroup_id', 'ad_name', 'ad_format', 'catalog_id', 'item_group_ids',
...
(async () => {
  ...
  console.log('Provider — leitura dos três níveis');
  {
    ...
    const expected = {
      ...
      adFormat: 'CATALOG_CAROUSEL', itemGroupIds: ['sku-1', 'sku-2'], musicId: 'music_1',
  ...
  console.log('Provider — capability exige contrato completo');
  {
    ...
    ok(complete.specificProducts && complete.productSets && !complete.catalogVideoTemplates, 'expõe item_group_ids/Product Set e remove template legado');
