...
assert.match(workspace, /Vídeo/);
assert.match(workspace, /Views 2s/);
assert.match(workspace, /Retenção 6s/);
assert.match(workspace, /Conclusão/);
assert.match(workspace, /Mais views 2s/);
assert.match(workspace, /Gasto sem venda real/);
assert.match(workspace, /Operação autônoma/);
assert.match(workspace, /Saúde dos conjuntos/);
...
assert.match(provider, /videoWatched2s/);
assert.match(provider, /videoWatched6s/);
assert.match(provider, /videoViewsP100/);
assert.match(provider, /averageVideoPlay/);
assert.match(provider, /Preview é enriquecimento visual best-effort/);

const types = read('dashboard/lib/types.ts');
assert.match(types, /videoWatched2s\?: number/);
assert.match(types, /videoWatched6s\?: number/);
assert.match(types, /videoViewsP100\?: number/);
assert.match(types, /averageVideoPlay\?: number/);
