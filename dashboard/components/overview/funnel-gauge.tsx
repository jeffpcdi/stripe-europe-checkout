  ...
  return (
    <div className="flex flex-col gap-3">
        ...
        {steps.map((step, idx) => {
          ...
          return (
            <div
              ...
              className={`group relative flex flex-col justify-between rounded-xl border p-2.5 transition-all duration-200 cursor-default ${
                isHovered
      ...
      <div className="hidden sm:flex items-center justify-between rounded-lg border border-white/[0.04] bg-white/[0.02] px-3 py-1.5 text-[10.5px] font-mono">
        <span className="text-white/40">Retenção de Funil:</span>
