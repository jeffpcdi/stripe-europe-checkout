...
import { CheckCircle2, ChevronLeft, ChevronRight, Loader2, Rocket, UploadCloud, X } from 'lucide-react'
  ...
  async function submit() {
    ...
    try {
      const payload = {
        ...
        endDate: form.budgetType === 'lifetime' ? form.endDate : undefined,
      ...
      toast.success('Campanha criada pausada', {
        hint: 'Revise a estrutura e ative quando estiver pronta. O Pixel de compra foi vinculado automaticamente.',
      })
      onCreated()
    } catch (submitError) {
        ...
        <header className="border-b border-border px-5 py-4">
          <div className="flex items-center justify-between gap-3">
            <div>
              ...
              <p className="mt-1 text-xs text-muted-foreground">Conversão · compra · TikTok · criada pausada</p>
            </div>
          ...
          {step === 0 && (
            <section className="anim-content-in space-y-4">
              ...
              <div className="rounded-xl border border-primary/20 bg-primary/5 p-3 text-xs text-muted-foreground">
                O objetivo, posicionamento, evento de compra e Pixel são definidos automaticamente. Nada precisa ser copiado do Gerenciador.
              </div>
            </section>
          )}
        ...
        <footer className="border-t border-border px-5 py-4">
          ...
          <div className="flex items-center justify-between gap-3">
            <button
              ...
              disabled={submitting}
            >
              {step > 0 && <ChevronLeft className="size-4" aria-hidden="true" />}
