...
function timeOnly(value?: string | null) {
  ...
  return Number.isNaN(d.getTime()) ? 'em breve' : d.toLocaleTimeString('pt-BR', { hour: '2-digit', minute: '2-digit' })
}
