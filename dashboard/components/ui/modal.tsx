...
export function Modal({ isOpen, onClose, title, description, children, maxWidth = 'max-w-md' }: ModalProps) {
  ...
  return (
    <DialogPortal><div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-2.5 backdrop-blur-sm sm:p-6" onClick={e => { if (e.target === e.currentTarget) onClose() }}>
