...
export class GlobeBoundary extends Component<{ children: ReactNode; embedded?: boolean }, { failed: boolean }> {
  state = { failed: false }
  static getDerivedStateFromError() { return { failed: true } }
  render() {
    if (!this.state.failed) return this.props.children
    return <div className={this.props.embedded ? 'observatory-globe-fallback' : 'presence-stage'}>
